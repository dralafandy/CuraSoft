...
const SupplierStatement: React.FC<SupplierStatementProps> = ({ supplier, clinicData }) => {
    ...
    const { supplierInvoices, expenses } = clinicData;
    ...
    return (
        <div className="p-8 bg-white text-slate-900 min-h-screen" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
            <header className="text-center mb-10">
                ...
                <h2 className="text-3xl font-bold text-primary-dark mt-6 mb-2">{t('supplierStatement.financialTitle')}</h2>
