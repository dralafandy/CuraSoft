...
export type View = 'dashboard' | 'patients' | 'scheduler' | 'doctors' | 'suppliers' | 'inventory' | 'labCases' | 'expenses' | 'treatmentDefinitions' | 'reports' | 'settings' | 'userManagement' | 'accountSelection'; // Removed 'financialAccounts', 'accountDetails'
